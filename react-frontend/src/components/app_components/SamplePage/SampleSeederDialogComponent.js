...
import seederData from "./sample.seeder.json";
...
const SampleSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SampleSeederDialogComponent);
